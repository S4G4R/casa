...
ENV JVM_OPTS="-DHYPERFIDDLE_ELECTRIC_APP_VERSION=$HYPERFIDDLE_ELECTRIC_APP_VERSION"
...
ENV JAVA_OPTS="-DHYPERFIDDLE_ELECTRIC_APP_VERSION=$HYPERFIDDLE_ELECTRIC_APP_VERSION"
